...
this.workJob.job(function(promise){//id, cb){
  promise.then(function(promise, result){
    ...
    console.log(promise.config.id + ': third part of the task - this won\'t run until after the resolve and other part')
    console.log(result + '!')
    return result + '!'
  }).then(function(promise, result){
    console.log(promise.config.id + ': fourth part of the task - this won\'t run until after the resolve and other parts')
    console.log(result + '!')
  })
